...
?>
    <div class="allpage">
        ...
        <div>
            ...
            <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site fap.mmi-lepuy.fr et de ses services.
        ...
        <div>
            ...
            <p>Le site fap.mmi-lepuy.fr est édité par le groupe FAP, domicilié au 5 rue Jean Baptiste Fabre.</p>
        </div>
        <div>
            <h2>ARTICLE 3 : accès aux services</h2>
            <p>L’Utilisateur du site fap.mmi-lepuy.fr a accès aux services suivants :
                •	Renseignement
                •	Inscription
        ...
        <div>
            ...
            <p>L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site fap.mmi-lepuy.fr.
        ...
        <div>
            ...
            <p>Tout dysfonctionnement du serveur ou du réseau ne peut engager la responsabilité de l’Éditeur.
                ...
                Le site fap.mmi-lepuy.fr s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.
        ...
        <div>
            ...
            <p>Les contenus du site fap.mmi-lepuy.fr (logos, textes, éléments graphiques, vidéos, etc.) sont protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.
        ...
        <div>
            ...
            <p>L’Utilisateur doit obligatoirement fournir des informations personnelles pour procéder à son inscription sur le site. 
                L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site fap.mmi-lepuy.fr pour la communication d’informations diverses et la gestion du compte.
                fap.mmi-lepuy.fr garantie le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.
                En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :
                    ...
                    •	Par mail à festivalartisanatpuyenvelay@gmail.com;
            </p>
        </div>
        <div>
            <h2>ARTICLE 8 : Liens hypertextes</h2>
            <p>Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de fap.mmi-lepuy.fr, qui n’a pas de contrôle sur ces liens.
                Il est possible pour un tiers de créer un lien vers une page du site fap.mmi-lepuy.fr sans autorisation expresse de l’éditeur.
            </p>
        </div>
        <div>
            <h2>ARTICLE 9 : Évolution des conditions générales d’utilisation</h2>
            <p>Le site fap.mmi-lepuy.fr se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.</p>
        </div>
        <div>

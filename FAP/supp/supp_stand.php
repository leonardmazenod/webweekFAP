...
// Requête pour supprimer le stand que l'on a choisi ( a l'aide d'un bouton disponible sur sa page admin)//
$requete='DELETE FROM stand WHERE id_stand='.$id; 
$resultats = $bdd->query($requete) ;

if ($resultats==true){
	echo "Le stand a bien été supprimé de la base de donnée du site.";
}

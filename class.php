...
Class Boutique extends Commerce{
    ...
    public function affiche_boutique(){
        echo"<h3>".$this->nom."</h3><ul><li>Description : ".$this->description."</li><li>Type : ".$this->type."</li><li>Horaire d'ouverture : ".$this->ouverture."</li><li>Horaire de fermeture : ".$this->fermeture."</li><li>Téléphone de la Boutique : ".$this->telboutique."</li></ul><img alt='image de la boutique ".$this->nom."' src='ajout/ajouter/".$this->img."' height=200px width=auto>";
    }
}
...
Class Stand extends Commerce{
    ...
    public function affiche_stand(){
        echo"<h3>".$this->nom."</h3><ul><li>Description : ".$this->description."</li><li>Type : ".$this->type."</li><li>Horaire d'ouverture : ".$this->ouverture."</li><li>Horaire de fermeture : ".$this->fermeture."</li><li>Type d'emplacement du stand : ".$this->emplacement."</li></ul><img alt='image de la boutique ".$this->nom."' src='ajout/ajouter/".$this->img."' height=200px width=auto>";
    }
}

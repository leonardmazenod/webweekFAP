...
if (mysqli_query($connection, $requete)) { echo "La mise à jour du nom de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour du nom de la boutique  : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour du type de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour du type de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la coordonée X de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de la coordonée X de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la coordonée Y de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de la coordonée Y de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la description de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de la description de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la description de l'horaire d'ouverture boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de l'horaire d'ouverture de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la description de l'horaire de fermeture boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de l'horaire de fermeture de la boutique : " . mysqli_error($connection)."</br>"; }}

if ($_POST['tel']!=$tab[9]){
$connection = mysqli_connect("localhost", "root", "", "festival");
// Requête pour modifier l'horaire d'ouverture de la boutique dans le cas où l'admin l'a demandé //
$requete = 'UPDATE boutique SET telboutique="'.$_POST['tel'].'" WHERE id_boutique='.$id; 
if (mysqli_query($connection, $requete)) { echo "La mise à jour de la description du téléphone de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour du téléphone de la boutique : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour de l'image de la boutique est un succés </br>"; } 
else { echo "Echec de la mise à jour de l'image de la boutique : " . mysqli_error($connection)."</br>"; }}

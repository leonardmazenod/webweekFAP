...
else { echo "Echec de la mise à jour du nom de la stand  : " . mysqli_error($connection)."</br>"; }}
...
if (mysqli_query($connection, $requete)) { echo "La mise à jour du type du stand est un succés </br>"; } 
else { echo "Echec de la mise à jour du type du stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de la coordonée X de la stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de la coordonée Y de la stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de la description de la stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de l'horaire d'ouverture de la stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de l'horaire de fermeture de la stand : " . mysqli_error($connection)."</br>"; }}

if ($_POST['emplacement']!=$tab[9]){
$connection = mysqli_connect("localhost", "root", "", "festival");
// Requête pour modifier l'horaire d'ouverture de la stand dans le cas où l'admin l'a demandé //
$requete = 'UPDATE stand SET emplacement="'.$_POST['emplacement'].'" WHERE id_stand='.$id; 
if (mysqli_query($connection, $requete)) { echo "La mise à jour de l'emplacement du stand est un succés </br>"; } 
else { echo "Echec de la mise à jour du téléphone de la stand : " . mysqli_error($connection)."</br>"; }}
...
else { echo "Echec de la mise à jour de l'image de la stand : " . mysqli_error($connection)."</br>"; }}
